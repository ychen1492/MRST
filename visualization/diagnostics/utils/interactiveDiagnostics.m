    ...
    function selection = getTOFSelection()
        ...
        if (compute_average)
            ...
            selection = selectTOFRegion(D, max_tof, min_tof, ...
                                        ...
                                        'set_op', set_op, ...
                                        'near_well_max_tof', near_well_max_tof);
%             % Convert logical array to integers (0s and 1s)
%             integer_array = uint8(selection);
% 
%             % File path to write
%             file_path = 'ho_sweeping_area_240_100.txt';
% 
%             % Open file for writing
%             fileID = fopen(file_path, 'w');
% 
%             % Write the array to the file
%             for i = 1:size(integer_array, 1)
%                 fprintf(fileID, '%d ', integer_array(i, :));
%                 fprintf(fileID, '\n');
%             end
% 
%             % Close the file
